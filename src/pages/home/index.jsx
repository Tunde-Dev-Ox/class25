        ...
        <div className={styles.waitlist}>
          <div className={styles.waitlist__innerwrapper}>
            <div className={styles.waitlist__content__text}>
                ...
                <div className={styles.main__header_wrapper}>
                  ...
                  <nav>
                    <ul className={styles.main__header__nav}>
                      <li>
                        <Link to="/meet-the-finalists">Meet finalists</Link>
                      </li>
                      <li>
              ...
              <h1>
                From freshmen to{" "}
                <span className={styles.waitlist__content__text__highlight}>
                  finalists
                </span>
              </h1>
              <p className={styles.waitlist__content__text__description}>
                Five years of growth, laughter, stress, and success. Let us take
                you through our journey at the Creative Arts Department,
                University of Lagos.
              </p>
              <div className={styles.join__waitlist}>
                <Link
                  to="https://forms.gle/uDcxwLRjBbYWC9S5A"
                  className={styles.join__waitlist__btn}
                >
